...
data_path = "./Traffic_Flow_Prediction/traffic_dataset.mat"
...
################################################################################################################################
############################################ Creating pandas dataframe for data ################################################
# dummy_record = pd.DataFrame()
# for i in range(data.shape[0]):
#     dummy_record=dummy_record.append(pd.DataFrame(data[i]))
# locNames = ["Loc"+str(i) for i in range(1,37)]
# dummy_record.insert(0,'LocName',locNames*1261)
# loc1_dummy_record=dummy_record[dummy_record['LocName']=='Loc1'].copy()
# loc1_dummy_record.rename({0:'y'},axis=1,inplace=True)
# X = loc1_dummy_record.drop(['LocName','y'],axis=1).copy()
# Y = loc1_dummy_record['y'].copy()
# print(X.head())
# print(X.shape)
